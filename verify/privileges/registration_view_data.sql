-- Verify database-registration-view-data:privileges/registration_view_data on pg
...
SELECT pg_catalog.has_sequence_privilege('registration_view_data', 'registration.registrations_global_position_seq', 'usage');
SELECT pg_catalog.has_sequence_privilege('registration_view_data', 'registration.registrations_global_position_seq', 'select');
